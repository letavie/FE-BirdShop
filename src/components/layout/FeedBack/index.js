                ...
                <div className={cx('feedback')}>
                    <div className={cx('feedback-item')}>
                        ...
                        <p className={cx('des')}>
                            ...
                            product. The bird cage is very sturdy and made of high-quality materials, making it durable
                            and reliable.
                        </p>
                    </div>
                    <div className={cx('feedback-item')}>
                        ...
                        <p className={cx('des')}>
                            ...
                            quickly and friendly. I feel confident buying products from them.
                        </p>
                    </div>
                </div>
            </div>
